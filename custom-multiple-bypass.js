/* 
   Combined Root Bypass, SSL Pinning Bypass & Re-Pinning Script
   Author: Asisten Frida
   Version: 1.1
*/

// ======================= PART 1: Root Bypass & SSL Pinning Bypass =======================
const commonPaths = [
    "/data/local/bin/su",
    "/data/local/su",
    "/data/local/xbin/su",
...
// ======================= PART 2: SSL Re-Pinning =======================
setTimeout(function(){
    Java.perform(function (){
        console.log("\n[!] Starting SSL Re-Pinning Process");
        ...
        try {
            ...
            SSLContext.init.overload("[Ljavax.net.ssl.KeyManager;", "[Ljavax.net.ssl.TrustManager;", "java.security.SecureRandom").implementation = function(a,b,c) {
                console.log("[+] Overriding TrustManager with custom CA");
                this.init(a, tmf.getTrustManagers(), c);
            };

            console.log("[✓] SSL Re-Pinning Complete!");
        } catch(e) {
            console.log("[X] Re-Pinning Failed: " + e.message);
        }
    });
}, 2000); // Delay 2 detik setelah bypass selesai

// ======================= PART 3: Universal SSL Pinning Bypass =======================
setTimeout(function(){
    Java.perform(function() {
        console.log("---");
...
/* 
   Cara Pakai:
   1. Push sertifikat Burp ke device:
      adb push burpca.crt /data/local/tmp/cert-der.crt
   2. Jalankan script:
      frida -U -f com.target.app -l custom-multiple-bypass.js
*/